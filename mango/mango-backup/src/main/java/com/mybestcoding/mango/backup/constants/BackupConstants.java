package com.mybestcoding.mango.backup.constants;
...
public class BackupConstants {
     ...
     * 默认备份文件名
     */
    public static final String BACKUP_FILE_NAME = "mamgo" + SQL_EXT;
    /**
     * 默认备份还原目录名称
     */
     ...
     * 默认备份还原文件
     */
    public static final String DEFAULT_RESTORE_FILE = BACKUP_FOLDER + DEFAULT_BACKUP_NAME + File.separator + BACKUP_FOLDER_NAME;
}
