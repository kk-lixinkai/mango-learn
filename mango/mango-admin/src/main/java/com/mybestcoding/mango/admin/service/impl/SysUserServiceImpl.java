...
import com.mybestcoding.mango.admin.mapper.SysUserMapper;
import com.mybestcoding.mango.admin.mapper.SysUserRoleMapper;
import com.mybestcoding.mango.admin.service.SysMenuService;
import com.mybestcoding.mango.admin.service.SysUserService;
import com.mybestcoding.mango.common.utils.DateTimeUtils;
import com.mybestcoding.mango.common.utils.PoiUtils;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public PageResult findPage(PageRequest pageRequest) {
        ...
        Object name = pageRequest.getParams("name");
        Object email = pageRequest.getParams("email");
        if (name != null) {
            if (email != null) {
